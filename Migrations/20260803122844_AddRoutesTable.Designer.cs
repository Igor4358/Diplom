...
namespace WMS.Terminal.Migrations
{
    ...
    [Migration("20260803122844_AddRoutesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Terminal.Models.Route", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WMS.Terminal.Models.Route", b =>
                {
                    b.HasOne("WMS.Terminal.Models.Warehouse", "FromWarehouse")
                        .WithMany()
                        .HasForeignKey("FromWarehouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Terminal.Models.Warehouse", "ToWarehouse")
                        .WithMany()
